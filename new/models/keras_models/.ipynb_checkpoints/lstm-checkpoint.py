...
from models.keras_utils import LastTimestep, ExtendMask 


class Network(Model):

    def __init__(self, dim, batch_norm, dropout, rec_dropout, task, mask_demographics,
                 target_repl=False, deep_supervision=False, num_classes=1,
                 depth=1, input_dim=94, **kwargs):
        ...
        # ADJUST INPUT DIMENSION ACCORDINGLY
