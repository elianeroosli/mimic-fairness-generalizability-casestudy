...
def main():
    ...
    ### FOR EVERY SUBJECT: ONLY RETAIN EVENTS THAT CAN BE ASSOCIATED TO A VALID ICU STAY ###
    for (index, subject) in enumerate(subjects):
        sys.stdout.write('\rfinished processing {0} / {1}'.format(index+1, len(subjects)))

        ### 1) PROCESS STAYS DATA ###
